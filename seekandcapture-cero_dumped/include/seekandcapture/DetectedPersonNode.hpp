#ifndef SEEKANDCAPTURE__DETECTEDPERSONNODE_HPP_
#define SEEKANDCAPTURE__DETECTEDPERSONNODE_HPP_
...
class DetectedPersonNode : public BT::ConditionNode
{
public:
  explicit DetectedPersonNode(
  ...
  static BT::PortsList providedPorts()
  {
    return BT::PortsList(
      {
        BT::OutputPort<std::string>("detection"),
      });
  }
